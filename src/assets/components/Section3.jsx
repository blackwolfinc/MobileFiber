  ...
  return (
    <div className="   w-full lg:min-w-[1424px] mt-[-3rem] sm:mt-0 h-full min-h-[520px] mb-[3rem] sm:mb-0 sm:min-h-[782px]  flex flex-col">
      ...
      <div className=" flex flex-col  items-center justify-center text-[#5F5F63]  sm:mt-[4rem] sm:ml-0 sm:scale-100 p-4 sm:p-0">
        <h1 className="text-lg  font-light tracking-wide 	 leading-[2rem] sm:leading-[3rem] text-center 	 sm:text-[2rem] sm:mt-[-1rem] sm:w-8/12  w-full  sm:text-center">
          Mobile Fiber Optic run under two big company how help us to manage our
          connection safe
        </h1>
        <h1 className="text-lg font-light tracking-wide leading-[2rem]	 sm:leading-[3rem] mt-6  text-center 	 sm:text-[2rem] sm:mt-[3rem] sm:w-8/12  w-full sm:text-center">
